...
import type { LevelSchemaAssets } from './levelsMapper.types';
...
/**
 * Generate a Zod schema for validating LevelMap JSON data dynamically based on the provided assets.
 */
export const createLevelMapSchema = (assets: LevelSchemaAssets): z.ZodType<LevelMap> => {
  console.log('createLevelMapSchema: assets', assets);
  ...
  const SelectionOptionSchema = z.object({
    ...
    // itemKey: z.enum(assets.itemKeys).optional(),
        ...
        z.object({
          ...
          battle: z.object({
            ...
            winData: z.object({
              ...
              // itemKeys: z.array(z.enum(assets.itemKeys)),
  ...
  return z.object({
    ...
    tiles: z.record(WallCoordSchema, z.string().nullable()),
    // tiles: z.record(WallCoordSchema, z.enum(LEVEL_TILES_NAME).nullable()),
    // tiles: z.record(WallCoordSchema, z.enum(assets.levelTilesNames).nullable()),
